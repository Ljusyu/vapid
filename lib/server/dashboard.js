...
router.get('auth#sign_in', '/sign_in', ctx => {
  return ctx.render('auth/sign_in', { flash: ctx.flash() })
})
...
router.get('records#index', '/groups/:id/records', findGroup, ctx => {
  return ctx.render('layout', { yield: 'records/index' })
})

router.get('records#new', '/groups/:id/records/new', findGroup, ctx => {
  return ctx.render('layout', { yield: 'records/new', action: router.url('records#create', ctx.state.group.id) })
})
...
router.get('records#edit', '/records/:id/edit', findRecord, ctx => {
  return ctx.render('layout', { yield: 'records/edit', action: router.url('records#update', ctx.state.record.id) })
})

router.get('records#delete', '/records/:id/delete', findRecord, ctx => {
  return ctx.render('layout', { yield: 'records/delete' })
})
