...
function _config() {
  let { vapid } = require(resolve(this.cwd, 'package.json'))
  return Utils.merge({}, defaults, vapid || {})
}
...
function _db() {
  ...
  if (dbConfig.dialect == 'sqlite') {
    Utils.mkdirp(this.paths.data)
    dbConfig.storage = resolve(this.paths.data, `${this.env}.sqlite`)
  }
